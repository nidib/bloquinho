...
const textareaVariants = cva(
	[
		...
		'border border-zinc-200 ring-offset-white hover:border-zinc-300 focus:ring-0 focus-visible:border-zinc-700 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-zinc-700 focus-visible:ring-offset-2',
	],
	{
		variants: {
			size: {
